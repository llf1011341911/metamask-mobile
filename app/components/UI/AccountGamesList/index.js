 ...
 */
class AccountGamesList extends PureComponent {
  static propTypes = {
    /**
    ...
    return (
      <SafeAreaView style={styles.wrapper} testID={'account-list'}>
        <View style={styles.titleWrapper}>
          <Text>{strings('games.wallet_choose_section')}</Text>
        </View>
        <FlatList
...
AccountGamesList.contextType = ThemeContext;
...
export default connect(mapStateToProps)(AccountGamesList);
